...
address is that even this asynchronous algorithm cannot efficiently parallelize a
...
implementation to incremental updates (where equalities and new terms may
