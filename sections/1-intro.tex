...
algorithm can achieve near linear speedups up to 32 cores on random
benchmarks(\todo{add a specific number}), a synthetic benchmark suite designed to
stress test our algorithm, and a set of circuit equivalence
benchmarks~\cite{eqsat}. Finally, we discuss what would be required to integrate
it into an existing SMT solver or equality saturation engine. 
